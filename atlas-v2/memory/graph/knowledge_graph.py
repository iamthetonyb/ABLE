...
class KnowledgeGraph:
    """
    Graph-based memory system for ATLAS.
    ...
    Usage:
        graph = KnowledgeGraph(db_path="~/.atlas/memory/knowledge.db")
    ...
    def __init__(
        ...
        self.db_path = Path(db_path or "~/.atlas/memory/knowledge.db").expanduser()
