"""
ATLAS Fact Checker - Prevents hallucinations and validates AI outputs.
...
class ClaimType(Enum):
    ...
    INTERNAL = "internal"       # References to ATLAS's own memory
...
class FactChecker:
    ...
    Integrates into the ATLAS pipeline between Auditor and Executor.
