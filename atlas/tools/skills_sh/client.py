...
Usage:
    from atlas.tools.skills_sh import search_skills, install_skill
...
# Skills known to be high-value for ATLAS workflows (pre-evaluated)
RECOMMENDED_SKILLS = [
    {
        "skill": "find-skills",
...
class SkillsShClient:
    ...
    SKILLS_LIBRARY_PATH = Path("atlas/skills/library")
    SKILLS_INDEX_PATH = Path("atlas/skills/SKILL_INDEX.yaml")
